      ...
      >
        ...
        <div className="overflow-y-auto px-5 py-4 space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-th-border-subtle">
              <div className="flex items-center gap-3 min-w-0">
                ...
                />
                <div>
                  <p className="text-[13px] text-th-text-secondary">Autoplay</p>
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                <Volume2 size={16} className="text-th-text-muted shrink-0" />
                <div>
          ...
          <div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-th-border-subtle">
              <div className="flex items-center gap-3 min-w-0">
                <AppWindow size={16} className="text-th-text-muted shrink-0" />
                <div>
                  <p className="text-[13px] text-th-text-secondary">
                    Window decorations
                  </p>
          ...
          <div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3 min-w-0">
                <RefreshCw size={16} className="text-th-text-muted shrink-0" />
                <div>
                  <p className="text-[13px] text-th-text-secondary">
                    Refresh App
                  </p>
